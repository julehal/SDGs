...
# Zeichnen der Knotenränder
nx.draw_networkx_nodes(G_synergy, pos, node_size=[1.3 * node_weights.get(node, 1) for node in G_synergy.nodes()], node_color='black')
# Zeichnen der Knoten
...
# Knotenlabels hinzufügen
nx.draw_networkx_labels(G_synergy, pos, font_size=10)
